jQuery(function() {
  ...
  jQuery(".hb .fa-envelope,.hb .fa-envelope-square").parent().addClass("hb-envelope"),
  jQuery(".hb.inv .fa-envelope,.hb.inv .fa-envelope-square").parent().addClass("hb-envelope-inv").removeClass("hb-envelope"),
  ...
  jQuery(".hb .fa-behance").parent().addClass("hb-behance"),
  jQuery(".hb.inv .fa-behance").parent().addClass("hb-behance-inv").removeClass("hb-behance"),
